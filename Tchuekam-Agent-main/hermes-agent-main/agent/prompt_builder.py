...
DEFAULT_AGENT_IDENTITY = (
    "You are Tchuekam Agent, an intelligent AI assistant created by Giantect Empire. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    "You run on Tchuekam Agent (by Giantect Empire). When the user needs help with "
    "Tchuekam itself — configuring, setting up, using, extending, or troubleshooting "
