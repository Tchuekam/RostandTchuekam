...
def cmd_whatsapp(args):
    ...
    if (session_dir / "creds.json").exists():
        ...
        if wa_mode == "bot":
            ...
            print()
            print("  Tip: Agent responses are prefixed with '⚕ Tchuekam Agent'")
        else:
            print("  Next steps:")
            print("    1. Start the gateway:  hermes gateway")
...
def cmd_postinstall(args):
    ...
    print("⚕ Tchuekam post-install bootstrap")
    print()
    ...
    if not git_dir.exists():
        if sys.platform == "win32":
            ...
            if method == "pip":
                ...
                return
            print("✗ Not a git repository. Please reinstall Tchuekam Agent.")
            sys.exit(1)
